/*
 * LeaderOS 3D Printer Firmware
 * based on Marlin 3D Printer Firmware
 *
 * This configuration file is dedicated for the Ender 3 v2 with the Fysetc Cheetah 1.2 board, and with BL Touch.
 * Please be kind, since this is our first firmware.
 *
 * Copyright (c) 2023 @LeadOn @Twixer [https://github.com/LeadOn/LeaderOS]
 *
 * ================================================================================
 *
...
#define STRING_CONFIG_H_AUTHOR "(LeaderOS, 2.1.2.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeaderOS - Ender 3 v2"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 400, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.5, -4.36, -2.58 } 
