/**
 * LeadOS 3D Printer Firmware
 * based on Marlin 3D Printer Firmware
 *
 * This configuration file is dedicated for the Ender 3 with the Fysetc Cheetah 1.2 board, and with CR Touch and Creality Sprite Extruder.
 * Please be kind, since this is our first firmware.
 *
 * Copyright (c) 2023 @LeadOn [https://github.com/LeadOn/LeadOS]
 *
 * ================================================================================
...
#define STRING_CONFIG_H_AUTHOR "(LeadOS, 2.1.2.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeadOS - Ender Hybrid"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 151.99
  #define DEFAULT_bedKi  28.29
  #define DEFAULT_bedKd 544.31
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36.5, -40, -1.765 }
...
#define Z_PROBE_FEEDRATE_FAST (1200)
