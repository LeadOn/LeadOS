...
#define STRING_CONFIG_H_AUTHOR "(LeaderOS, 0.0.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeaderOS - 0.0.1 - WD12 230 DUAL"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, 10, -2.64 }
