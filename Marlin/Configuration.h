...
#define STRING_CONFIG_H_AUTHOR "(LeaderOS, 1.0.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeaderOS 1.0 - Ender 3 v2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, 7, -0.5 }
