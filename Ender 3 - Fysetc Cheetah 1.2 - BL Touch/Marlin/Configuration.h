 ...
 *
 * This configuration file is dedicated for the Ender 3 with the Fysetc Cheetah 1.2 board, and with BL Touch.
 * Please be kind, since this is our first firmware.
 *
 * Copyright (c) 2022 @LeadOn @Twixer [https://github.com/LeadOn/LeaderOS]
 *
 * ================================================================================
 *
...
#define STRING_CONFIG_H_AUTHOR "(LeaderOS, 2.1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LeaderOS - Ender 3"
